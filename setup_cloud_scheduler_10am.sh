...
# Google Cloud Scheduler 10AM 设置脚本
# 每天上午10点运行WeeklyReporter，处理2天前的数据

# 配置变量
PROJECT_ID="solar-idea-463423-h8"
REGION="asia-east1"
JOB_NAME="weeklyreporter-daily-10am"
CLOUD_RUN_URL="https://weeklyreporter-crwdeesavq-de.a.run.app/run"
SCHEDULE="0 10 * * *"  # 每天上午10点
TIME_ZONE="Asia/Hong_Kong"
DESCRIPTION="WeeklyReporter 每日上午10点执行 - 处理2天前数据"

echo "🚀 开始设置Google Cloud Scheduler (10AM Daily)"
echo "================================================"
echo "项目ID: $PROJECT_ID"
echo "区域: $REGION" 
echo "任务名称: $JOB_NAME"
echo "执行时间: 每天上午10点 (Hong Kong时区)"
...
if [ $? -eq 0 ]; then
    ...
    echo "📋 任务详情:"
    echo "   任务名称: $JOB_NAME"
    echo "   执行时间: 每天上午10点 (Asia/Hong_Kong)"
...
echo ""
echo "🎉 设置完成！WeeklyReporter将每天上午10点自动运行。" 